...
- **Current phase:** Phase 3 — 3.1 + 3.2 + 3.3 + 3.4 code landed; Phase 1 + Phase 2 + Phase 3 device verification still pending
- **Next sub-phase:** [4.1 — `NoteExporter` + PNG share + `FileProvider` bootstrap](./STYLUS_NOTES_PHASE_4.md#sub-phase-41--noteexporter-core--png-share-target)
