...
- **Current phase:** Phase 2 — 2.1–2.3 landed; Phase 1 device verification still pending
- **Next sub-phase:** [2.4 — OCR on save (lazy pipeline)](./STYLUS_NOTES_PHASE_2.md#sub-phase-24--ocr-on-save-lazy-pipeline)
